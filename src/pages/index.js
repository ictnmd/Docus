...
const CategoryCards = [
  {
    ...
    link: "/docs/category/kiến-thức-chung",
    icon: "📚",
  ...
  },
  {
    ...
    link: "/docs/category/câu-hỏi-trắc-nghiệm",
    icon: "❓",
    gradient: "linear-gradient(135deg, #1581BF 0%, #3DB6B1 100%)",
  },
];
